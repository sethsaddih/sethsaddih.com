  ...
  return (
    <nav className="fixed inset-x-0 top-3 z-50 px-3 sm:top-4 sm:px-5">
      ...
      <div
        ...
        className={`mobile-nav-wrap mx-auto mt-2 max-w-[1440px] md:hidden ${menuOpen ? "is-open" : "is-closed"}`}
